...
//select p.id, r.person_id, r.related_person_id, r.relation_type, r.connection_type,rel_p.extra_info as rel_person_info from tree t
//join person p on p.tree_id=t.id
//join relation r on r.person_id = p.id
//join person rel_p on rel_p.id = r.related_person_id
//where t.id = 1
